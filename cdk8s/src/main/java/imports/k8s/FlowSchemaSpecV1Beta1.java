 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.94.0 (build b380f01)", date = "2024-02-08T08:57:15.713Z")
...
public interface FlowSchemaSpecV1Beta1 extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<FlowSchemaSpecV1Beta1> {
        imports.k8s.PriorityLevelConfigurationReferenceV1Beta1 priorityLevelConfiguration;
        imports.k8s.FlowDistinguisherMethodV1Beta1 distinguisherMethod;
        java.lang.Number matchingPrecedence;
        java.util.List<imports.k8s.PolicyRulesWithSubjectsV1Beta1> rules;
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements FlowSchemaSpecV1Beta1 {
        ...
        protected Jsii$Proxy(final Builder builder) {
            ...
            this.rules = (java.util.List<imports.k8s.PolicyRulesWithSubjectsV1Beta1>)builder.rules;
        }

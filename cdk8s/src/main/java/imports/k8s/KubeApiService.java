 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.94.0 (build b380f01)", date = "2024-02-08T08:57:15.742Z")
...
public class KubeApiService extends org.cdk8s.ApiObject {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<imports.k8s.KubeApiService> {
        ...
        /**
         * @return a newly built instance of {@link imports.k8s.KubeApiService}.
         */
        @Override

 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.94.0 (build b380f01)", date = "2024-02-08T08:57:15.783Z")
...
public class KubeEvent extends org.cdk8s.ApiObject {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<imports.k8s.KubeEvent> {
        ...
        /**
         * reportingController is the name of the controller that emitted this Event, e.g. <code>kubernetes.io/kubelet</code>. This field cannot be empty for new Events.
         * <p>
         * @return {@code this}
         * @param reportingController reportingController is the name of the controller that emitted this Event, e.g. <code>kubernetes.io/kubelet</code>. This field cannot be empty for new Events. This parameter is required.
         */
        ...
        /**
         * reportingInstance is the ID of the controller instance, e.g. <code>kubelet-xyzf</code>. This field cannot be empty for new Events and it can have at most 128 characters.
         * <p>
         * @return {@code this}
         * @param reportingInstance reportingInstance is the ID of the controller instance, e.g. <code>kubelet-xyzf</code>. This field cannot be empty for new Events and it can have at most 128 characters. This parameter is required.
         */
        ...
        /**
         * @return a newly built instance of {@link imports.k8s.KubeEvent}.
         */
        @Override

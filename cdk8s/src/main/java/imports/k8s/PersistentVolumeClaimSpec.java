 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.94.0 (build b380f01)", date = "2024-02-08T08:57:15.859Z")
...
public interface PersistentVolumeClaimSpec extends software.amazon.jsii.JsiiSerializable {
     ...
     * specified.
     * (Beta) Using this field requires the AnyVolumeDataSource feature gate to be enabled.</li>
     * </ul>
     */
    default @org.jetbrains.annotations.Nullable imports.k8s.TypedLocalObjectReference getDataSourceRef() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PersistentVolumeClaimSpec> {
        ...
        imports.k8s.TypedLocalObjectReference dataSourceRef;
         ...
         * @return {@code this}
         */
        public Builder dataSourceRef(imports.k8s.TypedLocalObjectReference dataSourceRef) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PersistentVolumeClaimSpec {
        ...
        private final imports.k8s.TypedLocalObjectReference dataSourceRef;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.dataSourceRef = software.amazon.jsii.Kernel.get(this, "dataSourceRef", software.amazon.jsii.NativeType.forClass(imports.k8s.TypedLocalObjectReference.class));
        ...
        @Override
        public final imports.k8s.TypedLocalObjectReference getDataSourceRef() {

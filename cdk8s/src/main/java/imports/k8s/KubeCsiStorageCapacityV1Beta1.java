 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.94.0 (build b380f01)", date = "2024-02-08T08:57:15.776Z")
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.KubeCsiStorageCapacityV1Beta1")
public class KubeCsiStorageCapacityV1Beta1 extends org.cdk8s.ApiObject {

    protected KubeCsiStorageCapacityV1Beta1(final software.amazon.jsii.JsiiObjectRef objRef) {
        super(objRef);
    }

    protected KubeCsiStorageCapacityV1Beta1(final software.amazon.jsii.JsiiObject.InitializationMode initializationMode) {
        super(initializationMode);
    }

    static {
        GVK = software.amazon.jsii.JsiiObject.jsiiStaticGet(imports.k8s.KubeCsiStorageCapacityV1Beta1.class, "GVK", software.amazon.jsii.NativeType.forClass(org.cdk8s.GroupVersionKind.class));
    }
     ...
     */
    public KubeCsiStorageCapacityV1Beta1(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String id, final @org.jetbrains.annotations.NotNull imports.k8s.KubeCsiStorageCapacityV1Beta1Props props) {
     ...
     * @param props initialization props. This parameter is required.
     */
    public static @org.jetbrains.annotations.NotNull java.lang.Object manifest(final @org.jetbrains.annotations.NotNull imports.k8s.KubeCsiStorageCapacityV1Beta1Props props) {
        return software.amazon.jsii.JsiiObject.jsiiStaticCall(imports.k8s.KubeCsiStorageCapacityV1Beta1.class, "manifest", software.amazon.jsii.NativeType.forClass(java.lang.Object.class), new Object[] { java.util.Objects.requireNonNull(props, "props is required") });
    }
    ...
    /**
     * A fluent builder for {@link imports.k8s.KubeCsiStorageCapacityV1Beta1}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.k8s.KubeCsiStorageCapacityV1Beta1> {
        /**
        ...
        private final imports.k8s.KubeCsiStorageCapacityV1Beta1Props.Builder props;

        private Builder(final software.constructs.Construct scope, final java.lang.String id) {
            this.scope = scope;
            this.id = id;
            this.props = new imports.k8s.KubeCsiStorageCapacityV1Beta1Props.Builder();
        }
        ...
        /**
         * @return a newly built instance of {@link imports.k8s.KubeCsiStorageCapacityV1Beta1}.
         */
        @Override
        public imports.k8s.KubeCsiStorageCapacityV1Beta1 build() {
            return new imports.k8s.KubeCsiStorageCapacityV1Beta1(
                this.scope,
                this.id,
                this.props.build()
            );

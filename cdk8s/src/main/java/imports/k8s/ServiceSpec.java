 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.94.0 (build b380f01)", date = "2024-02-08T08:57:15.894Z")
...
public interface ServiceSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * externalName is the external reference that discovery mechanisms will return as an alias for this service (e.g. a DNS CNAME record). No proxying will be involved.  Must be a lowercase RFC-1123 hostname (https://tools.ietf.org/html/rfc1123) and requires <code>type</code> to be "ExternalName".
     */
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ServiceSpec> {
         ...
         * @param externalName externalName is the external reference that discovery mechanisms will return as an alias for this service (e.g. a DNS CNAME record). No proxying will be involved.  Must be a lowercase RFC-1123 hostname (https://tools.ietf.org/html/rfc1123) and requires <code>type</code> to be "ExternalName".
         * @return {@code this}
         */

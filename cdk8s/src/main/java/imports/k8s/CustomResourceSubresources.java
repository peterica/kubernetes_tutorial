 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.94.0 (build b380f01)", date = "2024-02-08T08:57:15.694Z")
...
public interface CustomResourceSubresources extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * scale indicates the custom resource should serve a <code>/scale</code> subresource that returns an <code>autoscaling/v1</code> Scale object.
     */
    ...
    /**
     * status indicates the custom resource should serve a <code>/status</code> subresource.
     * <p>
    ...
    public static final class Builder implements software.amazon.jsii.Builder<CustomResourceSubresources> {
         ...
         * @param scale scale indicates the custom resource should serve a <code>/scale</code> subresource that returns an <code>autoscaling/v1</code> Scale object.
         * @return {@code this}
         */
         ...
         * @param status status indicates the custom resource should serve a <code>/status</code> subresource.
         *               When enabled: 1. requests to the custom resource primary endpoint ignore changes to the <code>status</code> stanza of the object. 2. requests to the custom resource <code>/status</code> subresource ignore changes to anything other than the <code>status</code> stanza of the object.
         * @return {@code this}
         */

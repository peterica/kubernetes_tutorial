 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.94.0 (build b380f01)", date = "2024-02-08T08:57:15.728Z")
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.HpaScalingRulesV2Beta2")
@software.amazon.jsii.Jsii.Proxy(HpaScalingRulesV2Beta2.Jsii$Proxy.class)
public interface HpaScalingRulesV2Beta2 extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.k8s.HpaScalingPolicyV2Beta2> getPolicies() {
        return null;
    }
    ...
    /**
     * @return a {@link Builder} of {@link HpaScalingRulesV2Beta2}
     */
    static Builder builder() {
        return new Builder();
    }
    /**
     * A builder for {@link HpaScalingRulesV2Beta2}
     */
    public static final class Builder implements software.amazon.jsii.Builder<HpaScalingRulesV2Beta2> {
        java.util.List<imports.k8s.HpaScalingPolicyV2Beta2> policies;
        java.lang.String selectPolicy;
        java.lang.Number stabilizationWindowSeconds;

        /**
         * Sets the value of {@link HpaScalingRulesV2Beta2#getPolicies}
         * @param policies policies is a list of potential scaling polices which can be used during scaling.
         *                 At least one policy must be specified, otherwise the HPAScalingRules will be discarded as invalid
         * @return {@code this}
         */
        @SuppressWarnings("unchecked")
        public Builder policies(java.util.List<? extends imports.k8s.HpaScalingPolicyV2Beta2> policies) {
            this.policies = (java.util.List<imports.k8s.HpaScalingPolicyV2Beta2>)policies;
            return this;
        }

        /**
         * Sets the value of {@link HpaScalingRulesV2Beta2#getSelectPolicy}
        ...
        /**
         * Sets the value of {@link HpaScalingRulesV2Beta2#getStabilizationWindowSeconds}
         ...
         * @return a new instance of {@link HpaScalingRulesV2Beta2}
         * @throws NullPointerException if any required attribute was not provided
         */
        @Override
        public HpaScalingRulesV2Beta2 build() {
            return new Jsii$Proxy(this);
        }
    }

    /**
     * An implementation for {@link HpaScalingRulesV2Beta2}
     */
    @software.amazon.jsii.Internal
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements HpaScalingRulesV2Beta2 {
        private final java.util.List<imports.k8s.HpaScalingPolicyV2Beta2> policies;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.policies = software.amazon.jsii.Kernel.get(this, "policies", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.HpaScalingPolicyV2Beta2.class)));
        ...
        protected Jsii$Proxy(final Builder builder) {
            ...
            this.policies = (java.util.List<imports.k8s.HpaScalingPolicyV2Beta2>)builder.policies;
            this.selectPolicy = builder.selectPolicy;
            this.stabilizationWindowSeconds = builder.stabilizationWindowSeconds;
        }

        @Override
        public final java.util.List<imports.k8s.HpaScalingPolicyV2Beta2> getPolicies() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            struct.set("fqn", om.valueToTree("k8s.HpaScalingRulesV2Beta2"));
        ...
        public final boolean equals(final Object o) {
            ...
            HpaScalingRulesV2Beta2.Jsii$Proxy that = (HpaScalingRulesV2Beta2.Jsii$Proxy) o;

 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.94.0 (build b380f01)", date = "2024-02-08T08:57:15.893Z")
...
public interface ServiceReference extends software.amazon.jsii.JsiiSerializable {
    ...
    /**
     * <code>name</code> is the name of the service.
     * <p>
     * Required
     */
    ...
    /**
     * <code>namespace</code> is the namespace of the service.
     * <p>
     * Required
     */
    ...
    /**
     * <code>path</code> is an optional URL path which will be sent in any request to this service.
     */
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ServiceReference> {
         ...
         * @param name <code>name</code> is the name of the service. This parameter is required.
         *             Required
         * @return {@code this}
         */
         ...
         * @param namespace <code>namespace</code> is the namespace of the service. This parameter is required.
         *                  Required
         * @return {@code this}
         */
         ...
         * @param path <code>path</code> is an optional URL path which will be sent in any request to this service.
         * @return {@code this}
         */
